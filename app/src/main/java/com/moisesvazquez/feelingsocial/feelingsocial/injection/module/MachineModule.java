...
import com.moisesvazquez.feelingsocial.feelingsocial.data.net.MachineMonkeyRestApiImpl;
...
public class MachineModule {
    ...
    @PerActivity
    @Named("IntentList")
    UseCase provideGetIntentListUseCase(GetIntentListUseCase getIntentList) {
        return getIntentList;
    }

    @Provides
    @PerActivity
    MachineRestApi provideMachineRestApi(MachineMonkeyRestApiImpl restMachineApi) {
        return restMachineApi;
    }
